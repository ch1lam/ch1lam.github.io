...
![servediter配置.jpg](servediter配置.jpg)

### 效果

![servediter效果.jpg](servediter效果.jpg)
...
- [搭建自己的云端 IDE](https://brief-rf.gitee.io/code-server/)
- [为 iPad 部署基于 VS Code 的远程开发环境](https://sspai.com/post/60456)
- [【编程】云端 IDE 介绍与搭建教程｜｜新的编程方式增加了！](https://www.bilibili.com/video/BV1Zz411i7rp/)
