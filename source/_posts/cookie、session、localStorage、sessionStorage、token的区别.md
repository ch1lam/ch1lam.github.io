---
title: cookie、session、localStorage、sessionStorage、token 的区别
index_img: /img/cookie、session、localStorage、sessionStorage、token 的区别.jpg
date: 2022-05-02 14:46:49
tags: [JavaScript]
categories: [大前端]
---

区分 cookie、session、localStorage、sessionStorage、token 的概念、工作机制、应用场景以及异同点
...
[面试题：请问 cookie，localStorage，sessionStorage 的区别\_田江的博客 - CSDN 博客](https://blog.csdn.net/jiang7701037/article/details/89118086)

[详说 Cookie, LocalStorage 与 SessionStorage | 咀嚼之味 (jerryzou.com)](https://jerryzou.com/posts/cookie-and-web-storage/)

[Cookie、Session、localStorage、sessionStorage 区别和用法 - SegmentFault 思否](https://segmentfault.com/a/1190000039670664)

[简单理解 token 的作用及实现原理\_蔡小波的博客 - CSDN 博客](https://blog.csdn.net/qq_22078107/article/details/87871252)
