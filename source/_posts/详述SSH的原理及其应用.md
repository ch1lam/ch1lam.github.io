---
title: 详述SSH的原理及其应用
date: 2022-04-27 17:55:53
index_img: /img/详述SSH的原理及其应用.jpg
tags: [Shell, Linux]
categories: [教程, VPS常见问题]
---

详解 SSH 的定义及原理，具体用法及其应用场景
...
[ssh（安全外壳协议） - 百度百科](http://baike.baidu.com/link?url=FBYD3gt-oTCm9Zis_6_LRDd6I86AWeHbmW5hiU9YeU8UUMR8QzSGL27FegWLcQ-iMmCs3aaRBAWDJ6FyHMha7K)
[ssh 原理与应用（一）：远程登录 - 阮一峰的网络日志](http://www.ruanyifeng.com/blog/2011/12/ssh_remote_login.html)
[ssh 原理与应用（二）：远程操作与端口转发 - 阮一峰的网络日志](http://www.ruanyifeng.com/blog/2011/12/ssh_port_forwarding.html)
